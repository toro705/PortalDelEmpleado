...
function Validar()
{
	...
	if(document.prefer.txtSmtpServer.value.length == 0)
		{
			error += "- Debe completar el campo Servidor Smtp\n";
       		pass = false;	
		}
	if(document.prefer.txtSmtpPort.value.length == 0)
		{
			error += "- Debe completar el campo Puerto Servidor Smtp\n";
       		pass = false;	
		}
	if(document.prefer.txtSmtpUser.value.length == 0)
		{
			error += "- Debe completar el campo Cuenta Envio\n";
       		pass = false;	
		}
	if(document.prefer.txtSmtpPass.value.length == 0)
		{
			error += "- Debe completar el campo Password Cuenta Envio\n";
       		pass = false;	
		}
